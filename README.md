...
3. Env vars (`CLOUDFLARE_API_TOKEN`, `MCP_BASE_URL`, `MCP_OAUTH_PASSWORD`, `FASTMCP_HTTP_ALLOWED_HOSTS`, `FASTMCP_HTTP_ALLOWED_ORIGINS`) vía la UI de Dokploy — el endpoint `application-saveEnvironment` de la API falló consistentemente con 400 al llamarlo programáticamente.
